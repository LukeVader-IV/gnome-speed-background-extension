...
class Extension{
	...
	enable(){
		// let settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.speedbackground');
...
this.OPACITY_STEP = {
    key: 'opacity-step',
    get: function () {
        return ExtensionUtils.getSettings('org.gnome.shell.extensions.speedbackground').get_double(this.key);
    }
};
